...
!function ( $ ) {
    ...
    Tag.prototype = {
        ...
        , show: function () {
            ...
            if (that.values.length) {
                $.each(that.values, function () {
                    that.createBadge(this, "carregando")
                })
            }
        ...
        , createBadge: function ( value, local = "" ) {
            var that = this

            $('<span/>', {
                'class' : "tag badge badge-pill badge-default tagBadge"
            })
                .text(value.toString())
                ...
                .insertAfter( local ? that.element : that.element.next() )
        }
        , add: function ( value ) {
            var that = this
